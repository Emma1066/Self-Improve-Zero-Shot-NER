...
def get_paths(args):
    ...
    args.prompt_path = f"prompts/{dataname}/{folder}/{prompt_filename}"
    ...
    response_dir = f"result/{model_folder}/{dataname}/{folder_resp}"
    ...
    log_dir = f"log/{model_folder}/{dataname}/{folder_log}"
